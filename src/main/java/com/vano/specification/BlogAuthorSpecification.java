package com.vano.specification;
...
public class BlogAuthorSpecification implements Specification<BlogAuthor> {

    private SearchCriteria criteria;

    public BlogAuthorSpecification(SearchCriteria criteria) {
